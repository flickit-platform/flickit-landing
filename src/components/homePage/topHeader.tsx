            ...
            <div className={"flex justify-center items-center w-full h-[20rem]  sm:h-[30rem]"}>
                ...
                <section
                    ...
                    <div className="font-light sm:font-normal text-[0.75rem] sm:text-[1.25rem] text-[#EDF4FC]">
                        Flickit is a software assessment platform. It allows software owners and developers to assess
                        their software across various subjects and attributes. Users can customize their assessment kits
