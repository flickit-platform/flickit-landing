export const QAs: { question: string, answer: string }[] = [
    {
...
export const cardsText: { title: string, text: string, color: string }[] = [
    {
        title: "1. Address the right assessment kit",
        text: "Pick the assessment kit that aligns perfectly with your concerns and covers your decision factors.",
        color: "#97D5FF"
    },
    {
        title: "2. Answer the questions",
        text: "Answer the questions in the chosen assessment kit and provide relevant details.",
        color: "#FFB2BD"
    },
    {
        title: "3. Explore the assessment insights",
        text: " Explore the insights and recommondations generated by the assessment process.",
        color: "#FFB872"
    },
]
