    ...
    return (
        <main className="mx-auto flex justify-center items-center relative h-[28.3rem] w-full  sm:max-h-[45.3rem] sm:h-[45.3rem]  lg:max-h-[62.3rem] lg:h-[62.3rem] ">
            ...
            <div className={"flex justify-center items-center w-full h-[20rem]  sm:h-[30rem]"}>
                <div className={"absolute bg-cover blur-2xl bg-[url(/meshGradiant.svg)] h-full w-full top-0 bottom-0 right-0 left-0"}/>
                <section className={`${sansation.className} relative  text-center gap-y-4 sm:gap-y-5 flex flex-col items-center justify-center w-[18.5rem] sm:w-[32rem] lg:w-[55.43rem] 2xl:w-[60rem] 3xl:w-[80rem]`}>
                    ...
                    <div className="drop-shadow-[5px_5px_20px_rgba(255,255,255,0.4)] text-[#EDF4FC] text-[1.5rem] sm:text-[2.5rem] lg:text-[4.5rem] font-bold leading-8 sm:leading-10 lg:leading-[5.625rem]">
