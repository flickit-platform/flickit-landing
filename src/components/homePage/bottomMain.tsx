...
const Slide = (items) => {
 const {color,text,title} = items
    ...
    return (
        <div onClick={func} style={{boxShadow: `inset 1px 1px 14px rgba(255, 255, 255, 12%)`}} className={`flex gap-[79px] flex-col items-center justify-start w-[9.37rem] h-[9.37rem] sm:w-[25rem] sm:h-[25rem] rounded-[0.75rem] sm:rounded-[2rem] px-8 py-[5.62rem] bg-gradient-to-b from-[#102D51] from-0% to-100% to-[#0A2342] `}>
