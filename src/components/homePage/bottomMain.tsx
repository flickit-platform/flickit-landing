 ...
 const {color,text,title,movement,index} = items
  //todo
    return (
        ...
        <h3 style={{color,filter: `drop-shadow(0px 0px 30px rgba(${color}))`}} className={"label-small sm:text-[1.2rem] sm:leading-5 lg:!headline-small text-center lg:w-[15.75rem] h-[2.5rem] sm:h-[5.12rem]"}>{title}</h3>
